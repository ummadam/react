    ...
    return function (WrappedComponent) { var _a; return _a = /** @class */ (function (_super) {
            ...
            function FirebaseAuthProvider() {
                ...
                _this.toggleLoading = function () {
                    return _this.setState(function (currState) { return ({ loading: !currState.loading }); });
                };
            ...
            FirebaseAuthProvider.prototype.componentDidMount = function () {
                var _this = this;
                this.toggleLoading();
                this.unsubscribeAuthStateListener = firebaseAppAuth.onAuthStateChanged(function (user) { return _this.setState({ user: user }); }, function (error) { return _this.setError(error.message); }, function () { return _this.toggleLoading(); });
            };
            ...
            FirebaseAuthProvider.prototype.render = function () {
                var props = __assign({}, this.props, this.sharedHandlers, { loading: this.state.loading, user: this.state.user, error: this.state.error });
